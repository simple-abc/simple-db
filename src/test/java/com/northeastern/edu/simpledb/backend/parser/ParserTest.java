...
class ParserTest {
    ...
    void testRead() throws Exception {
        String stat = "select name, id, age from student where id > 1 and id < 4";
        Object res = Parser.Parse(stat.getBytes());
    ...
    void testInsert() throws Exception {
        String stat = "insert into student values 5 \"jack\" 22";
        Object res = Parser.Parse(stat.getBytes());
    ...
    void testDelete() throws Exception {
        String stat = "delete from student where name = \"jack\"";
        Object res = Parser.Parse(stat.getBytes());
    ...
    void testUpdate() throws Exception {
        String stat = "update student set name = \"jack\" where id = 5";
        Object res = Parser.Parse(stat.getBytes());
